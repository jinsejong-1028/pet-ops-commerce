...
comment on table lots is '상품별 LOT 관리 정보';
comment on column lots.lot1 is 'LOT 주요 식별값';
comment on column lots.lot2 is '보조 LOT 정보';
comment on column lots.lot3 is '유효기간';
comment on column lots.lot4 is '입고일자';
comment on column lots.lot5 is '기타 관리값';
